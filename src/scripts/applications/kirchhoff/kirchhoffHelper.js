...
function showBrokenHeart() {
    ...
    setTimeout(() => {
        ...
        overlay.style.transform = "translate(-50%, -150%) scale(0.1)";
        overlay.style.opacity = "0";
    }, 250);
